...
import bgImg from '../public/assets/cyber-bg.png'
import Image from 'next/image'

const Hero = () => {
  return (
    <div id='hero' className='w-full relative h-screen bg-zinc-200 flex flex-col justify-between pt-[80px]'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            ...
            <div className='absolute -bottom-16 flex flex-col py-8 md:min-w-[760px] 
